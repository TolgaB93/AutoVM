...
<div class="scroll-sidebar">
            ...
            <div class="navigation">
                ...
                <ul class="nav hidden-sm hidden-xs">
                    ...
                    <li<?php echo ($c == 'server-pool' ? ' class="active"' : '');?>><a href="<?php echo Yii::$app->urlManager->createUrl('/admin/server-pool/index');?>"><i class="fa fa-filter"></i>Dedicated Pools</a></li>
